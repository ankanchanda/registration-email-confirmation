...
public class RegistrationService {
    ...
    public String register(RegistrationRequest request) {
        ...
        String token = userService.signUpUser(
                new AppUser(request.getFirstName(), request.getLastName(), request.getUsername(),
                        request.getEmail(), request.getPassword(), AppUserRole.USER));
        String confirmEmailLink = "http://127.0.0.1:8080/api/v1/registration/confirm?token=" + token;
        String emailBody = getEmailBody(request.getFirstName(), confirmEmailLink);
        emailService.send(request.getEmail(), "Confirm Your Email", emailBody);
        return token;
    }
    ...
    private String getEmailBody(String name, String link) {
